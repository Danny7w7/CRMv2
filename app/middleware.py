...
MODULE_PATHS = {
    ...
    'SMS': [ 'toggleDarkMode', 'smsBlue','chatSms','sendCreateSecretKey','sendSecretKey','deleteContact','sendMessage','startChat','stripe-webhook','payment','readAllMessages','adminSms'],
