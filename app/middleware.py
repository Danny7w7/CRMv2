...
MODULE_PATHS = {
    'OBAMACARE': [ 'formCreateClient', 'formEditClient', 'formCreatePlan','clientAccionRequired','clientObamacare','editObama','viewConsent','viewIncomeLetter','alert','ticketAsing','editTicket','editAlert','select_client','formAddObama','formAddDepend','formCreateAlert','validatePhone','fetchAca','fetchDependent','formCreatePlan','formCreatePlan','updateTypeSales','formAddObama','formAddSupp','addDependObama','toggleDependentsObama','validateKey','blockSocialSecurity','agentTicketAssignment','fetchActionRequired','saveCustomerObservationACA','saveDocumentClient','saveAppointment','saveAccionRequired','fetchPaymentsMonth','fetchActionRequired','fetchPaymentOneil','fetchPaymentCarrier','fetchPaymentSherpa','validarCita','paymentDateObama','preComplaint','ILFFM','clientObamacarePass','saveRenovation', 'requestsChangeDate', 'requestsChangeAgent', 'changePlanDate', 'changePlanAgent','fetchChangePlanDate','fetchChangePlanAgent', 'getReasonChange', 'sendEmailComplaint','saveMonitoring'],
    'SUPP': [ 'formCreateClient', 'formEditClient','formCreatePlan','clientSupp','editSupp','alert','ticketAsing','editTicket','editAlert','select_client','formAddSupp','formAddDepend','formCreateAlert','validatePhone','fetchSupp','fetchDependent','formCreatePlan','formCreatePlan','updateTypeSales','formAddObama','formAddSupp','addDependSupp','toggleDependentsSupp','validateKey','agentTicketAssignment','toggleSuppStatus','saveCustomerObservationSupp','fetchPaymentSuplementals','paymentDateSupp','saveDocumentClientSupp', 'requestsChangeDate', 'requestsChangeAgent', 'changePlanDate', 'changePlanAgent','fetchChangePlanDate','fetchChangePlanAgent', 'getReasonChange','saveCignaDraft','saveMonitoring'],
...
EXCLUDED_VIEWS = ['index', 'weeklyLiveViewTV', 'monthLiveViewTV', 'toggleDarkMode' ,'motivationalPhrase','login',
                  ...
                  'webhooks','check','facebook_connect','facebook_callback','subscribe_page_to_app','facebook_save_page','get_lead_details','facebook_webhook']  # Puedes agregar más si lo necesitas
