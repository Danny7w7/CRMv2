...
MODULE_PATHS = {
    ...
    'SUPP': [ 'formCreateClient', 'formEditClient','formCreatePlan','clientSupp','editSupp','alert','ticketAsing','editTicket','editAlert','select_client','formAddSupp','formAddDepend','formCreateAlert','validatePhone','fetchSupp','fetchDependent','formCreatePlan','formCreatePlan','updateTypeSales','formAddObama','formAddSupp','formAddDepend','addDepend','validateKey','agentTicketAssignment','toggleSuppStatus','saveCustomerObservationSupp','fetchPaymentSuplementals','paymentDateSupp','saveDocumentClientSupp', 'requestsChangeDate', 'requestsChangeAgent', 'changePlanDate', 'changePlanAgent','fetchChangePlanDate','fetchChangePlanAgent', 'getReasonChange'],
